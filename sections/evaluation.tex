...
\hline
$\MapleNineShort$-i-pure & 244 (148, 95) +0 & 4435.88 &  43.27\\
\hline
$\MapleNineShort$-i-min & 244 (148, 96) +1 & \textbf{4409.88} & \textbf{37.43} \\
\hline
$\MapleNineShort$-i-greedy & 243 (146, 97) + 0 & 4476.73 & 40.65 \\
\hline
$\MapleNineShort$-i-inclusive & \textbf{245} (\textbf{150}, 95) +2 & 4425.99 & 37.60 \\
\hline
\hline
SAT 2019 Competitor & & &\\
...
$\IUIP$ learning schemes show marginal improvement for $\MapleNineShort$. Despite significantly reducing clause size,  only two out of four configurations improved solved instances by 1 and 2 instances, respectively. $\MapleNineShort$ uses duplicate learning (DL) to prioritize clauses that are learned multiple times. $\IUIP$ and DL didn't synergies well possibly because different 1-UIP clause can be reduced to the same i-UIP clause through the $\IUIP$ learning; therefore, DL could encounter too many duplicate i-uip clauses to correctly prioritize the important clauses. \nf{should I run some experiment to validate my guess?, if the guess is valid, should I adjust DL settings to make it compatible with $\IUIP$}

...
$\IUIP$ learning schemes show marginal improvement on $\MapleNineShort$. Despite significantly reducing clause size,  only two out of four configurations improved solved instances by 1 and 2 instances, respectively. $\MapleNineShort$ remembers previously learned clauses, and prioritize the clause if the same clause (denote as duplicate clause) is learned again later. $\IUIP$ and duplicate learning (DL) didn't synergies well possibly because multiple 1-UIP clause can be derived to the same i-UIP clause through the $\IUIP$; therefore, duplicate clauses could appear too frequently for duplicate learning to prioritize the right clauses.

...
% 
\begin{abstract}
    Clause learning is an essential technique in \sat solvers.
    Almost all modern CDCL \sat solvers use the 1-UIP 
    clause learning scheme to learn new clauses from conflicts, 
    ...
    schemes, like $i$-UIP and all-UIP, that had been proposed in prior
    ...
    Our technique $\allUip$ employs all-UIP learning under the
    constraint that the learnt clause's LBD does not increase (over the
    minimum established by the 1-UIP clause). $\allUip$ can generate
    ...
    clause. We show empirically that $\allUip$ can improve the

...
$\allUipEx$. We chose $\cadical$ because its default configuration
...
$\stablealluip$ configurations solved 2, 6, 5 and 5 more instances
than \oneuip, respectively. $\MapleNineShort$ prioritizes clauses that
are learned multiple times. We observed that
$\stablealluip$ clauses are less likely to be duplicated. As an
...
both $\allUipAct$ and $\allUipIn$ show better performance than
...
Applying $\allUipAct$ and $\allUipIn$ helped the solver solve 3 and 2 more instances, respectively.  

...
\begin{abstract}
    ...
    Most of modern CDCL \sat solvers use the 1-UIP 
    ...
    minimum established by the 1-UIP clause). $\allUip$ can learn
    ...
    clause with the same asserting literal. We show empirically 
    that $\allUip$ can improve the performance of state of the art solvers.
\end{abstract}
